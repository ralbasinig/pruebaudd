...
import 'package:noteu_app/main.dart'; // Importa MainApp
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.white, // Color de fondo primario
      body: Center(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                '',
                style: TextStyle(
                  fontFamily: 'Poppins-Regular.ttf', // Nombre de la fuente personalizada
